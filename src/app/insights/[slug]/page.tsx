  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <article className="mt-6">
        ...
        <p className="mt-4 text-lg leading-8 text-stone-700">{insight.dek}</p>

        <div className="mt-8 space-y-5 text-lg leading-8 text-stone-800">
      ...
      <Card className="mt-10 p-5">
        <h2 className="text-xl font-semibold text-slate-950">Evidence used</h2>
          ...
          <div>
            ...
            <ul className="mt-3 grid gap-2">
              {insight.entity_ids.map((id) => (
                <li key={id} className="font-mono text-sm text-stone-700">
                  {id}
                </li>
              ))}
            </ul>
