...
export const countries: CountryProfile[] = [
  {
    ...
    "country": "China",
    "region": "East Asia",
    "summary": "China now has source-backed standards/evaluation records, dialogue/event records, frontier-developer disclosure records, and public technical-safety research records. These add PKU alignment tooling, BAAI FlagSafe/FlagEval, OpenCompass, BIGAI TongTest, and RUC interpretability/safety-alignment signals without treating generic AI work as frontier safety.",
    "government_posture": "The public technical-safety record is carried mainly by universities, research institutes, and public platforms rather than by a stand-alone national AISI equivalent in the reviewed sources.",
    ...
    "industry_ecosystem": "The most visible technical-safety actors are university, quasi-public, or institute-linked platforms rather than purely private frontier labs.",
  ...
  },
  {
    ...
    "research_ecosystem": "The research base mixes institutional coordination with concrete outputs on guardrails, safety datasets, and interpretable trustworthy foundation technologies. RIKEN NLU remains medium-confidence for core frontier-safety relevance.",
    ...
    "international_engagement": "NII’s symposium and LLM-jp network appear designed to connect academic, industry, and policy actors in an internationally legible format.",
    "open_questions": [
  ...
  },
  {
    ...
    "country": "South Korea",
    "region": "East Asia",
    "summary": "South Korea’s public technical-safety work is anchored by Korea AISI plus university evaluation work at Soongsil and method-level safety research at KAIST.",
  ...
  },
  {
    ...
    "industry_ecosystem": "The AIVF toolkit and its surrounding programs are designed to support practical testing and evaluation adoption across industry rather than to serve as a single research lab.",
  ...
  },
  {
    ...
    "country": "Regional",
    "region": "Southeast Asia",
    "summary": "ASEAN-wide profile for regional AI governance implementation. The register adds source-backed voluntary guidance, a generative-AI guide expansion, the Bangkok Digital Declaration, and a Malaysia official ASEAN AI Safe announcement while holding roadmap/search-snippet claims pending direct text.",
  ...
  },
  {
    ...
    "country": "Vietnam",
    "region": "Southeast Asia",
    "summary": "Vietnam is the clearest ASEAN national case with binding instruments: official sources show a 2021 AI strategy, a dedicated AI Law enacted in December 2025, a February 2026 implementation plan, and an April 2026 implementing decree.",
    ...
    "research_ecosystem": "The core country posture is grounded in official strategy and legal sources; broader research-community details remain for later primary-source backfill.",
  ...
  },
  {
    ...
    "country": "Indonesia",
    "region": "Southeast Asia",
    "summary": "Indonesia’s strongest directly retrieved official evidence is the 2023 ministerial circular on AI ethics plus a BRIN page indicating an AI and cybersecurity research centre under OREI.",
  ...
  },
  {
    ...
    "industry_ecosystem": "The sources emphasize university-led deployment and capacity building more than a large private safety-lab cluster.",
